...
const UUID = (process.env.UUID || "f1234c23-1234-4b60-1234-0f666cd5a8a8").trim(); // 双引号内填入UUID
const DOMAIN = (process.env.DOMAIN || "my.domain").trim(); // 托管到CF的域名（带前缀）
...
// =============== 启动信息 ===============
// ============================================================
const listenPort = Number(PORT) || 0; //  随机端口
